...
public class Product {
    ...
    public static void addItems(int num) {
        ...
        if (num % 2 != 0) {
            ...
            Product newNotebook = new Product(
                    id,
                    unitPriceInput,
                    discountRateInput,
                    stockInput,
            ...
            if (idExits && brandExits) {
                ...
                for (Product product : products.get("Notebook")) {
                    ...
                    if (brandProduct.equals(product.getNameBrand()) && product.getId() == idProduct) {
                        ...
                        filteredItemList(num, filteredProducts);
                        break;
                    } else {
                        // product not found.
                        System.out.println("The value ID or brand is not found in the system. Please check your ID or brand.");
                        filterItems(num);
                    }
                }
            } else {
                if (brandExits) {
                    ...
                    // products not found.
                    System.out.println("The brand is not found in the system. Please check your brand.");
                    filterItems(num);
                }
            }
    ...
    private static void filteredItemList(int num, ArrayList<Product> filteredProductList) {
